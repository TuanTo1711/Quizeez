...
public final class ComponentResizer extends MouseAdapter {
    ...
    private final static Map<Integer, Integer> cursors
            = Map.of(
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if (source instanceof JComponent jComponent) {
            jComponent.setAutoscrolls(autoscrolls);
        }
    }
     ...
     * constraints.All calculations are done using the bounds of the component
     * when the resizing started.
     *
     * @param e
     */
    @Override
    ...
    private Dimension getBoundingSize(Component source) {
        if (source instanceof Window ) {
            ...
            return new Dimension(windowBounds.width, windowBounds.height);
        }
