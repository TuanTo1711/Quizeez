...
public class SwitchButton extends JComponent {
    ...
    public void addEventToggleSelected(SwitchListener event) {
...
//        g2.fill(area);
        g2.drawImage(SVGIcon.MOON.getImage(), (int) location, shadowSize.top, null);

        //  Create ellipse selected color
        g2.setColor(getForeground());
        g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, animate));
//        g2.fill(area);
        g2.drawImage(SVGIcon.SUN.getImage(), (int) location, shadowSize.top, null);
