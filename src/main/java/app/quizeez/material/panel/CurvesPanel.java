package app.quizeez.material.panel;
...
public final class CurvesPanel extends GradientPanel {

    private final RenderingHints hints;
    private int counter = 0;
    private final Timer timer = new Timer(20, (ActionEvent ae) -> {
        repaint();
    });
    ...
    public CurvesPanel() {
        super(Color.decode("#00dbde"), Color.decode("#fc00ff"));
