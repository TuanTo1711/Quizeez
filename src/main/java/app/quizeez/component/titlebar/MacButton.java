package app.quizeez.component.titlebar;
...
public class MacButton extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdRe = new app.quizeez.component.titlebar.ButtonTitleBar();
        cmdMi = new app.quizeez.component.titlebar.ButtonTitleBar();
        cmdClose = new app.quizeez.component.titlebar.ButtonTitleBar();
    ...
    private app.quizeez.component.titlebar.ButtonTitleBar cmdClose;
    private app.quizeez.component.titlebar.ButtonTitleBar cmdMi;
    private app.quizeez.component.titlebar.ButtonTitleBar cmdRe;
