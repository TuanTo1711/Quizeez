...
public class MailService {
    ...
    public static NotificationModal sendMail(String toEmail, String code) {
        NotificationModal ms = new NotificationModal(false, "");

        if (!isAddressValid(toEmail)) {
            ms.setMessage("Invalid Email Address!");
            ms.setSuccess(false);
            return ms;
        }
        ...
        try {
            ...
            ms.setMessage("Send Successfully!");
            ms.setSuccess(true);
    ...
    public static boolean isAddressValid(String address) {
        ...
        for (int mx = 0; mx < mxList.size(); mx++) {
            int res;
            System.out.println(mxList.get(mx).toString());
